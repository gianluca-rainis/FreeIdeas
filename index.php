            ...
            <section id="imagesSectionHome">
                ...
                <ul id="imagesUl">
                    <li class="imageInfoLiHome">
                        <img src="./images/searchPreview.png" alt="Image of FreeIdeas info" class="imageHome">
                        <div>
                            <h1>Explore Ideas</h1>
                    ...
                    <li class="imageInfoLiHome">
                        <img src="./images/publishPreview.png" alt="Image of FreeIdeas info" class="imageHome">
                        <div>
                    ...
                    <li class="imageInfoLiHome">
                        <img src="./images/helpPreview.png" alt="Image of FreeIdeas info" class="imageHome">
                        <div>
                    ...
                    <li class="imageInfoLiHome lastImageInfoLi">
                        <img src="./images/ideaPreview.png" alt="Image of FreeIdeas info" class="imageHome">
                        <div>
                            <h1>Make it Real</h1>
