/* POSITION TOGGLE PASSWORD BUTTON DYNAMICALLY */
...
document.addEventListener('DOMContentLoaded', positionTogglePasswordButton);
window.addEventListener('resize', positionTogglePasswordButton);

/* TOGGLE PASSWORD IMAGE */
document.querySelectorAll(".toggle-password-visibility-ext").forEach(element => element.addEventListener("click", () => {
...
if (document.getElementById("forgotPasswordLoginPage")) {
    document.getElementById("forgotPasswordLoginPage").addEventListener("click", async () => {
